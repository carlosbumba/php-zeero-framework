...
abstract class Model
{
    ...
    private static function getTable()
    {
        ...
        $tbl = self::$models_tables[self::getAbsoluteClass()] ?? null;

        if (empty($tbl) or is_null($tbl)) {
            $tbl = self::getAbsoluteClass();
        }
