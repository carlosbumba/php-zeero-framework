...
class Router
{
    ...
    private $opcional;
    private $hasParams;
    private static $enableCSRF = true;
                ...
                if (preg_match($pattern, $path) or preg_match($pattern, $path . '/')) {
                    ...
                    if (isset($object->tokenHandler)) {
                        ...
                        foreach ($object->tokenHandler as $token) {
                            ...
                            $routeRequirement->requireValidToken($token, $params);
                        }
                    ...
                    $dispatcher->dispatch($object, $params);
                    return;
                }
            }
        }
